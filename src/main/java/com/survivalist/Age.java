...
@Getter
public enum Age {
    STEEL_AGE("Steel Age", NpcID.COUNT_DRAYNOR, "Leather", "Dramen", "Beekeeper", "Iron", "Bronze", "Steel", "Wizard", "Blue wizard", "Training", "Black robe", "Black skirt", "Blue skirt", "Studded", "Hardleather", "Oak"),
    MITHRIL_AGE("Mithril Age", NpcID.MELZAR_THE_MAD, "Mithril", "Mith", "Black", "White", "Initiate", "Frog-leather", "Xerician", "Willow"),
